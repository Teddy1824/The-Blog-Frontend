<template>
  ...
  <div class="container">
    <div v-if="lifestyles.length" class="row my-5 border shadow-5-strong py-5">
      <div
      ...
      >
        ...
        >
          <h2 class="card text-white animate__animated animate__zoomIn">
            <img :src="lifestyle.main_image" class="" alt="..." />
            {{ lifestyle.title }}
            <br />
            {{ lifestyle.subtitle }}
            <br />
    ...
    <div v-else>
      <p class="my-5">Loading Lifestyle...</p>
...
export default {
  ...
  mounted() {
    fetch("https://the-anything-blog.herokuapp.com/lifestyles", {
      method: "GET",
      headers: {
