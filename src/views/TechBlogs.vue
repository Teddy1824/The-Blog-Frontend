<template>
  ...
  <div class="container">
    <div v-if="tech.length" class="row my-5 border shadow-5-strong py-5">
      <div
        v-for="techs in tech"
        :key="techs._id"
      ...
      >
        ...
        >
          <h2 class="card text-white animate__animated animate__zoomIn">
            <img :src="techs.main_image" class="" alt="..." />
            {{ techs.title }}
            <br />
            {{ techs.subtitle }}
            <br />
...
export default {
  ...
  mounted() {
    fetch("https://the-anything-blog.herokuapp.com/tech", {
      method: "GET",
      headers: {
